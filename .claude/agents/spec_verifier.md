...
Lo primero que haces es leer `600_features/<feature>/state.json`, `spec.md`, `plan.md` y `definition.md`. Valida que `stages.integration_tester.status = "done"`. Si no, **detente** e infórmalo: no se verifica una feature sin integración cerrada.

## Referencias de proyecto

- `600_features/<feature>/spec.md` — **fuente de verdad** de la verificación (criterios de aceptación).
- `600_features/<feature>/definition.md` — criterios de aceptación de alto nivel y alcance.
...
En `600_features/<feature>/verification.md`:
