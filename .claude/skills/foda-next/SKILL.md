...
Ejecuta el **Protocolo de Inicio de Sesión** definido en `CLAUDE.md` (sección 1).
...
### 3. Confirmación
Antes de proponer o ejecutar acciones, ten claro:
- El estado actual del proyecto.
- La próxima tarea a realizar.
- Cualquier bloqueo o riesgo registrado.

Al terminar, presenta un resumen breve al usuario: **dónde está el proyecto** y **cuál es la próxima tarea**.
