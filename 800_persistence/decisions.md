...
| D-080 | Gate de progresión entre flujos por `success` del predecesor + `--force`; `foda run` refleja `success` en el exit code | Aceptada — implementación pendiente (T-035, T-036) | 2026-07-09 |
...
- **Estado:** Aceptada — **IMPLEMENTACIÓN PENDIENTE** (ver T-035, T-036)
- **Fecha:** 2026-07-09
